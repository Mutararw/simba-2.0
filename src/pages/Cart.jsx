...
const Cart = ({ lang }) => {
  ...
  const translations = {
    en: { title: "Your Cart", empty: "Your cart is empty", subtotal: "Subtotal", checkout: "Proceed to Checkout", continue: "Continue Shopping" },
    fr: { title: "Votre Panier", empty: "Votre panier est vide", subtotal: "Sous-total", checkout: "Passer à la Caisse", continue: "Continuer les Achats" },
    kn: { title: "Ikarita yawe", empty: "Ikarita yawe irimo ubusa", subtotal: "Iteranyirizo", checkout: "Komeza Kwishura", continue: "Komeza Gura" }
  }
  ...
  if (cart.length === 0) {
    return (
      <div className="container section-padding fade-in" style={{ textAlign: 'center' }}>
        ...
        <Link to="/" className="btn-primary">{t.continue}</Link>
      </div>
    )
  }
  ...
  return (
    <div className="container section-padding fade-in">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '3rem' }}>
        ...
        <div className="glass" style={{ padding: '2rem', borderRadius: '32px', height: 'fit-content', position: 'sticky', top: '100px' }}>
          <h2 style={{ fontSize: '1.5rem', fontWeight: '800', marginBottom: '1.5rem' }}>Summary</h2>
